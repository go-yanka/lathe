...
WORKFLOWS = {
    ...
    "sdlc": {
        ...
        "steps": [
            ...
            ("auto", "ASSUMPTION AUDIT: an adversarial auditor surfaces the choices the goal never specified; confirm the HIGH ones (the build refuses until then)", "assume {plan}"),
            ("you",  "Confirm or correct each blocking assumption (`lathe assume {plan} --confirm`) — correcting means making the choice explicit in the spec", ""),
